...
def Crete_Folder_Images(name, directory, tn):
    ...
    for i in tqdm(range(1, 1+ tn)):
        ...
        for(x,y,w,h) in faces:
            ...
            cv2.imwrite('d:/STUDY FILES   SEM 5/SCAM/PROJECT/Datasets/'+str(name)+'/'+str(name)+'_'+str(i)+'.jpg', res)  #for GRAY SCALE IMAGES
...
directory='d:/STUDY FILES   SEM 5/SCAM/PROJECT/Datasets/'+name
